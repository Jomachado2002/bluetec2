...
const MobileCategoriesPage = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="sticky top-0 z-10 p-4 shadow-md bg-green-600 text-white flex items-center">
        ...
        {productCategory.map((category) => (
          ...
          >
            <div className="bg-green-50 p-4 border-b border-green-100">
              <h2 className="text-lg font-bold text-green-800">{category.label}</h2>
            </div>
