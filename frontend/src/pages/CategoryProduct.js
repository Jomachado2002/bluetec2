...
const CategoryProduct = () => {
    ...
    const getSpecificationLabel = (specKey) => {
        const labels = {
            ...
            notebookScreen: 'Tamaño de Pantalla',
            notebookBattery: 'Batería',
            notebookScreen: 'Tamaño de Pantalla',

            // Monitores
            monitorSize: 'Tamaño de Monitor',
            ...
            // DVR
            dvrChannels: 'Número de Canales',
            dvrResolution: 'Resolución',
            dvrStorageCapacity: 'Capacidad de Almacenamiento',

            // Otros
            nasCapacity: 'Capacidad NAS',
            printerType: 'Tipo de Impresora',
            printerSpeed: 'Velocidad de Impresión',
            printerResolution: 'Resolución de Impresión',
            phoneStorage: 'Almacenamiento de Teléfono'
        };
