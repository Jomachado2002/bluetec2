...
import OptimizedImage from './OptimizedImage'; // Asegúrate de importar el componente

const HorizontalCardProduct = ({ 
  category, 
  subcategory = null, 
  heading,
  limit = 20, // Límite de productos para mostrar
  sortBy = 'price' // Campo por el que ordenar
}) => {
  ...
  const loadingList = new Array(9).fill(null); // Reducido para mejorar rendimiento
  ...
  }, [category, subcategory, limit, sortBy]);
  ...
  return (
    <div className="w-full px-2 sm:px-4 my-4 sm:my-6 relative">
          ...
          {loading ? loadingList.map((_, index) => (
            ...
            >
              ...
              <div className="flex h-full">
                <div className="w-2/5 h-full bg-white flex items-center justify-center p-2 relative">
                  <OptimizedImage 
